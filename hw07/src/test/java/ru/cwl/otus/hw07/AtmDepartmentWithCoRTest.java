 ...
 * on 05.12.2017 21:49.
 */
public class AtmDepartmentWithCoRTest {
    private static final int ATM_START_SUM = 630 + 6300 + 160;
    private AtmBuilder2 atmBuilder=new AtmBuilder2();

    private AtmDepartmentWithCoR atmDepartment = new AtmDepartmentWithCoR();
    private AtmWLink atm1, atm2, atm3;
    ...
    public void testSaveAndRestoreDepartState() {
        ...
        AtmMementoWLink memento = atmDepartment.saveToMemento();
